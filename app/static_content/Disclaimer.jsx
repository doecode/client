      ...
      <div className="row not-so-wide-row">
        ...
        <div className="col-md-6 col-xs-12 static-content">
          <div className="body-disclaimer">
            ...
            <h3>
              <a name="acceptable"></a>Acceptable Use Policy</h3>
            ...
            <p></p>
            <h3>
              <a name="privacy"></a>User Privacy</h3>
            <p></p>
            <h3>
            ...
            <ul>
              <li>
                <p>
                  <u>Session cookies</u>
                  last only as long as your browser is open; once the browser is closed the cookie disappears.</p>
              </li>
              <li>
                <p>
            ...
            <h3>
              <a name="copyright"></a>Copyright</h3>
            ...
            <h3>
              <a name="attribution"></a>Attribution</h3>
            ...
            <h3>
              <a name="security"></a>Website Security</h3>
            ...
            <h3>
              <a name="linkto"></a>Linking to OSTI Website</h3>
            <p>
            ...
            <h3>
              <a name="linkout"></a>Linking to Outside Websites</h3>
            <p>
            ...
            <h3>
              <a name="comments"></a>Comments Policy</h3>
            <p>
