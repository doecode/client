      ...
      <div className="row not-so-wide-row">
        ...
        <div className="col-md-6 col-xs-12 static-content">
          ...
          <p>
            ...
            <a target='_blank' href='https://www.osti.gov/includes/estsc/software_best_prac.html'>Software Best Practices document</a>.
            <br/>
          ...
          <p>
            ...
            <a target='_blank' href='https://www.osti.gov/stip/softwarecategories'>Software Categories table</a>. The table is not intended to provide an exhaustive list. Contact DOE CODE at (865) 576-2606 or&nbsp;
            <a href='mailto:doecode@osti.gov'>doecode@osti.gov</a>&nbsp;with questions.
            <br/>
          </p>
        </div>
        <div className="col-md-3"></div>
