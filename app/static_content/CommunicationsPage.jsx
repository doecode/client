      ...
      <div className="row not-so-wide-row">
        ...
        <div className="col-md-6 col-xs-12 static-content">
          ...
          <div className="padblock">
            ...
            <ul>
              <li>05/03/2017&nbsp;
                <a href="https://www.osti.gov/doecode/docs/billings_stip_20170503.pdf">The New Energy Science and Technology Software Center</a>&nbsp;presented at the DOE Scientific and Technical Information Program (STIP) Annual Working Meeting (Jay Jay Billings, Oak Ridge National Laboratory (ORNL))</li>
              <li>04/21/2017&nbsp;
                <a href="http://www.osti.gov/doecode/docs/DOE_Code_Code4LibSE_2017.pptx.zip">DOE CODE Metadata</a>&nbsp;by Katie Knight, Oak Ridge National Laboratory,&nbsp;<a href="https://wiki.code4lib.org/Southeast_2017#Code4LibSE_2017_Emory_Meeting">Code4LibSE 2017 Emory Meeting</a>
              </li>
          ...
          <div className="padblock">
            <ul>
              <li>
                <a href="https://github.com/doecode">DOE CODE GitHub site</a>
              </li>
              <li>
