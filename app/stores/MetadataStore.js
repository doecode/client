...
*/
	@observable metadataInfoSchema = {
	        ...
	        "developers": {required:"pub", label: "Developers", completed:false, hasError:false, ever_completed:false, validations: [], Panel: "Developers", error: ''},
            ...
            "release_date" : {required:"sub", label: "Release Date", completed:false, ever_completed:false, validations: [], Panel: "DOI and Release Date", error: ''},
            "sponsoring_organizations" : {required:"sub", label: "Sponsoring Organizations", completed:false, hasError:false, ever_completed:false, validations: [], Panel: "Organizations", error: ''},
            "research_organizations" : {required:"sub", label: "Research Organizations", completed:false, hasError:false, ever_completed:false, validations: [], Panel: "Organizations", error: ''},
	        ...
	        "country_of_origin": {required:"sub", label: "Country of Origin", completed:true, ever_completed:false, validations: [], Panel: "Supplemental Product Information", error: ''},
            ...
            "other_special_requirements": {required:"", completed:false, ever_completed:false, validations: [], Panel: "Supplemental Product Information", error: ''},
  	        ...
  	        "recipient_name": {required:"sub", label: "Name", completed:false, ever_completed:false, validations: [], Panel: "Contact Information", error: ''},
  	        "recipient_email": {required:"sub", label: "Email", completed:false, ever_completed:false, validations: ["email"], Panel: "Contact Information", error: ''},
  	        "recipient_phone": {required:"sub", label: "Phone", completed:false, ever_completed:false, validations: ["phonenumber"], Panel: "Contact Information", error: ''},
  	        "recipient_org": {required:"sub", label: "Organization", completed:false, ever_completed:false, validations: [], Panel: "Contact Information", error: ''},
   }
