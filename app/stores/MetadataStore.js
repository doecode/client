...
*/
	@observable metadataInfoSchema = {
		   	...
		   	"landing_page": {required:"", label: "Landing", completed:false, validations: ["URL"], Panel: "Repository Information", error: ''},
            ...
            "date_of_issuance" : {required:"sub", label: "Release Date", completed:false, validations: [], Panel: "DOI and Release Date", error: ''},
	        ...
	        "country_of_origin": {required:"sub", label: "Country of Origin", completed:false, validations: [], Panel: "Supplemental Product Information", error: ''},
