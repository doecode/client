          ...
          <div className='col-xs-12 no-col-padding-left no-col-padding-right'>
            ...
            <div className="collapse navbar-collapse no-col-padding-right no-col-padding-left" id='header-nav-collapse'>
              ...
              <ul className='nav navbar-nav nav-menu'>
                <NavBarItem current_page={this.current_page} destination='/doecode/projects' multDestinations={["/doecode/projects","/doecode/submit","/doecode/announce","/doecode/approve","/doecode/pending", "/doecode/confirm"]} navTitle='Submit Software/Code' special="true" fa_icon="fa fa-sign-in nav-menu-item-fa" display_name="Submit Software/Code"/>
