...
export default class UserEditFields extends React.Component {
    constructor(props) {
        ...
        sessionStorage.registerNeedsContractNumber = false;
        sessionStorage.hasDoneContractNumberCheck = false;
    }
    ...
    updateEmailAndCheckPassword(event) {
        ...
        this.checkPassword();
        if(!sessionStorage.hasDoneContractNumberCheck){
            doAjax('POST','/doecode/api/
        }
    }
    ...
    const validPassword = this.state.longEnough && this.state.hasSpecial && this.state.hasNumber && this.state.upperAndLower && this.state.matches &&
        ...
        <div className="row">
            <div className='col-xs-12'>
                {this.props.show_nonPass_fields &&
                <span>
                    <div className='row'>
                    ...
                    <div className="row">
                        <div className="col-md-6 col-xs-12">
                            <UserField field='contractNumber' label='Contract Number' elementType='input' noExtraLabelText/>
                        </div>
                        <div className='col-md-6'></div>
                    </div>
                    }
