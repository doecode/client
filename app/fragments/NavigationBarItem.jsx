...
export default class NavgationBarItem extends React.Component{
    ...
    this.li_class = (this.is_active)?" active-menu-item ":"";
    ...
    this.anchor_class = (this.is_active)? " nav-menu-item active-menu-item-text " : "nav-menu-item nav-menu-item-text";
    ...
    render(){
        ...
        <li className={this.li_class}>
            <a className={this.anchor_class} href={this.props.destination}><span className={this.fa_icon}></span> {this.props.display_name}</a>
        </li>
        );
    }
}
