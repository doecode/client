...
public class DOECODEJson {
      ...
      public DOECODEJson() {
            ...
            this.search_sort_options_list.add(makeListObj("Release Date (newest to oldest)", "releaseDate desc",
                        "Release Date (newest to oldest)"));
            this.search_sort_options_list.add(makeListObj("Release Date (oldest to newest)", "releaseDate asc",
            ...
            this.license_options_list
                        .add(makeListObj("Apache License 2.0", "Apache License 2.0", "Apache License 2.0"));
            this.license_options_list.add(makeListObj("GNU General Public License v3.0",
            ...
            this.license_options_list.add(makeListObj("Eclipse Public License 1.0", "Eclipse Public License 1.0",
                        "Eclipse Public License 1.0"));
            this.license_options_list.add(makeListObj("GNU Affero General Public License v3.0",
                        "GNU Affero General Public License v3.0", "GNU Affero General Public License v3.0"));
            this.license_options_list.add(makeListObj("GNU General Public License v2.0",
                        "GNU General Public License v2.0", "GNU General Public License v2.0"));
            this.license_options_list.add(makeListObj("GNU General Public License v2.1",
                        "GNU General Public License v2.1", "GNU General Public License v2.1"));
            ...
            this.license_options_list.add(makeListObj("Mozilla Public License 2.0", "Mozilla Public License 2.0",
      ...
      public final void UPDATE_REMOTE_LISTS() throws Exception {
            ...
            // Countries
            ArrayNode country = getItemFromElinkAuthority(
                        authorityapi_base_url + "simple/countries-list?sort=description");
            if (country.size() > 0) {
            ...
            // Research Org
            ArrayNode research_orgs = getItemFromElinkAuthority(
                        authorityapi_base_url + "research/orig-research-org-list");
            ...
            // Affiliations
            ArrayNode affiliations = getItemFromElinkAuthority(
                        authorityapi_base_url + "affiliations/affiliations-list");
      ...
      private ArrayNode translateElinkAuthorityList(ArrayNode original_list) {
            ...
            for (JsonNode n : original_list) {
                  ...
                  String name_val = (n instanceof TextNode) ? n.asText()
                              : JsonUtils.getString((ObjectNode) n, "name", "");
